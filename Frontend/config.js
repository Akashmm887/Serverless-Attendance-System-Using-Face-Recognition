...
function uploadImage() {
  canvas.toBlob(blob => {
    ...
    fetch("https://9wyfwwbvx5.execute-api.us-east-1.amazonaws.com/upload", {
      method: "POST",
...
function loadAttendanceData() {
  ...
  fetch(`https://9wyfwwbvx5.execute-api.us-east-1.amazonaws.com/attendance?employeeId=${employeeId}`)
    .then(res => res.json())
    .then(data => {
